...
def process_split(train_index, test_index, X_, y_, scaler, k_params, parameter):
    ...
    model = svr_qcqp_multi_kernel_l1(
    ...
    return metric, y_pred.flatten(), X_[test_index], model.mu, y_pred_train.flatten(), X_train, y_train, model.beta
...
filename = 'custom_kernel_qcqp_l1_trace.pkl'
