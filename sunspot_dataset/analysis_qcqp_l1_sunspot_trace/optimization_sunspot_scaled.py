...
# folds = []
# tsv = TimeSeriesSplit(test_size=12, n_splits=10)
# for split_idx in tsv.split(X_):
#     folds.append(split_idx)

# fold_num = 9


# fold_idx = folds[fold_num]
# X_train, X_test, y_train, y_test = X_[fold_idx[0]], X_[fold_idx[1]], y_[fold_idx[0]], y_[fold_idx[1]]
...
# %% parameters
logs_name = "results/kernelscaled_true_stdscaler_trace_opt_testsize12"
load_previous = False
...
params = {
    'C': (1e-5, 1e2, "float"),
    # 'C': (13.333667, None, None, "stationary"),
    # 'C': (10, 19, 4, "float"),
    'epsilon': (1e-3, 15, "float"),
    # 'epsilon': (2e-1, None, "stationary"),
    # 'epsilon': ([0.2, 0.4, 0.6], None, None, "cat"),
    'tau': (1e3, 5e3, "float"),
    # 'tau': (22222.222999999998, None, None, "stationary"),
    # 'tau': (1e2, 4e2, 4, "float"),
    'kernel_params': (k_params, None, "stationary"),
    # 'kronecker_kernel': ([True, False], None, None, "cat")
